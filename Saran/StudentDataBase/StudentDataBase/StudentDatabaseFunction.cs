...
namespace StudentDataBase
{
    class StudentDatabaseFunction
    {
        ...
        {
            students[noStudentsAdded, 0] = id.ToString();
            students[noStudentsAdded, 1] = name;
            students[noStudentsAdded, 2] = mark1.ToString();
            students[noStudentsAdded, 3] = mark2.ToString();
            students[noStudentsAdded, 4] = mark3.ToString();
            noStudentsAdded++;
        }
        ...
        public void PrintAllStudentInfo()
        {
            ...
            for (int i = 0; i < noStudentsAdded; i++)
            {
